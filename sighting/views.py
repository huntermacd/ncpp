...
def bird_detail(request, bird_name):
	# grab bird captured by url, display its data
	...
	# if user has sighting for bird, load form with that data
	# otherwise, load blank form, allow for creation of sighting
